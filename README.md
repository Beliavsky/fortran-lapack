...
This repository is a downstream fork of [Federico Perini's fortran-lapack](https://github.com/perazz/fortran-lapack). It extends `pure` declarations through additional BLAS/LAPACK procedures and interfaces. See the [pure-procedure comparison report](PURE_PROCEDURE_DIFFERENCES.md), generated by [the comparison script](scripts/compare_pure_procedures.py), for commit-pinned source comparisons with the upstream repository.
