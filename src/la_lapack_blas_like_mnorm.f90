...
module la_lapack_blas_like_mnorm
     ...
     pure real(sp) function la_slange(norm,m,n,a,lda,work)
        use la_constants_sp
        ! -- lapack auxiliary routine --
        ! -- lapack is a software package provided by univ. of tennessee,    --
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
       ...
       ! =====================================================================
           ...
           if (min(m,n) == 0) then
              ...
              ! find normi(a).
              allocate (row_sums(m),source=zero)
              do j = 1,n
                 do i = 1,m
     ...
     pure real(qp) function la_qlange(norm,m,n,a,lda,work)
        use la_constants_qp
        ! -- lapack auxiliary routine --
        ! -- lapack is a software package provided by univ. of tennessee,    --
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
     ...
     pure real(sp) function la_slansy(norm,uplo,n,a,lda,work)
        use la_constants_sp
        ! -- lapack auxiliary routine --
        ! -- lapack is a software package provided by univ. of tennessee,    --
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
     ...
     pure real(qp) function la_qlansy(norm,uplo,n,a,lda,work)
        use la_constants_qp
        ! -- lapack auxiliary routine --
        ! -- lapack is a software package provided by univ. of tennessee,    --
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
     ...
     pure real(sp) function la_clange(norm,m,n,a,lda,work)
        use la_constants_sp
        ! -- lapack auxiliary routine --
        ! -- lapack is a software package provided by univ. of tennessee,    --
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
     ...
     pure real(qp) function la_wlange(norm,m,n,a,lda,work)
        use la_constants_qp
        ! -- lapack auxiliary routine --
        ! -- lapack is a software package provided by univ. of tennessee,    --
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
