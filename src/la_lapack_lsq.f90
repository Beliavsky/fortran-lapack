...
module la_lapack_lsq
     ...
     pure subroutine la_zgelsd(m,n,nrhs,a,lda,b,ldb,s,rcond,rank,work,lwork,rwork, &
               iwork,info)
     ...
     pure subroutine la_zgelss(m,n,nrhs,a,lda,b,ldb,s,rcond,rank,work,lwork,rwork, &
               info)
